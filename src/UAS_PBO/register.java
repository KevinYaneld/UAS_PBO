...
public class register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 80, 150, -1));
        ...
        jPanel1.add(txtCPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 140, 150, -1));
        jPanel1.add(txtPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, 150, -1));
        ...
        jPanel1.add(btnRegister, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 200, -1, -1));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, 60, -1));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 300));
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        String cpassword = String.valueOf(txtCPass.getPassword());
        
        if (username.isEmpty() || password.isEmpty() || cpassword.isEmpty() || !password.equals(cpassword)) {
            JOptionPane.showMessageDialog(this,"Form Isian Belum Lengkap / Konfirmasi Password Salah", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            try {
                try (Connection conn = koneksi.getConnection()) {
                    ...
                    if (rs.next()) {
                        JOptionPane.showMessageDialog(this, "Username Ini Telah Terdaftar Mohon Gunakan Username Lain");
                    } else {
                        // Insert user information into the database
                        query = "INSERT INTO tbl_user (username, password, role, validasi) VALUES ('" + username + "', '" + password + "', 'User', 'Belum')";
